        ...
        <ImageBackground source={require("../assets/login_bg.jpg")} style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1, justifyContent:'center', alignItems:'center' }} >
            ...
            height: 125, width: 125, alignItems:'center', justifyContent:'center' }} >
              <Text style={{ fontWeight: 'bold', fontSize: 24 }}>PANDER</Text>
            </View>
          </View>
          ...
          <View>
            ...
            <View style={{ height: 150, backgroundColor: 'white' }}>
              <View style={{
                ...
                <Text style={{ fontSize: 22 }}>Get stuff done, with Pander</Text>
              </View>
              ...
              <TouchableOpacity>
                <View style={{
                  ...
                  <View
                    ...
                    {/* Country Code */}
                    <Text style={{ fontSize:16, paddingHorizontal: 10}}>+234</Text>
                    {/* Phone Number Input */}
                    <TextInput 
